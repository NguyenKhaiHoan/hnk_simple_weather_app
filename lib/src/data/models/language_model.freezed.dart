...
abstract class $LanguageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, String value});
}
...
class _$LanguageModelImpl implements _LanguageModel {
  const _$LanguageModelImpl({required this.code, required this.value});
  ...
  @override
  String toString() {
    return 'LanguageModel(code: $code, value: $value)';
  }
...
abstract class _LanguageModel implements LanguageModel {
  const factory _LanguageModel(
      ...
      required final String value}) = _$LanguageModelImpl;
